...
| ------------- | ------------- |
| GICAT | The GICAT visualizes the class structure of an object-oriented programmed software project. It shows the genealogy based on Git,   as well as the software project’s heredity of classes |
